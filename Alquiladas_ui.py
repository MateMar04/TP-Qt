...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1405, 498)
        MainWindow.setMinimumSize(QSize(1405, 498))
        MainWindow.setMaximumSize(QSize(1405, 498))
        ...
        self.verticalLayoutWidget.setGeometry(QRect(190, 10, 1201, 461))
        ...
        self.lb_casas.setGeometry(QRect(60, 340, 41, 17))
        ...
        self.pb_terminar_contrato.setGeometry(QRect(20, 440, 131, 25))
        ...
        self.pb_eliminar_propiedad.setGeometry(QRect(18, 410, 131, 25))
        MainWindow.setCentralWidget(self.centralwidget)
        self.menuBar = QMenuBar(MainWindow)
        self.menuBar.setObjectName(u"menuBar")
        self.menuBar.setGeometry(QRect(0, 0, 1405, 22))
